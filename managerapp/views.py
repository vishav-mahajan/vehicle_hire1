    ...
    try:
        if (request.method == "POST"):
            ...
            if form.is_valid():
                ...
                f1.vehicle_category_name = request.POST['vehicle_category_name']
...
def vehicle_details(request):
    ...
    if request.method=="POST":
        ...
        if form.is_valid():
            ...
            f.save()
            return render(request,"vehicledetails.html",{'valid':True,'cd':companydata,"ccd":companycategorydata,'yr':year})
        else:
            return render(request, "vehiclecategories.html", {'invalid':True})
